<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="mst_Country.aspx.cs" Inherits="bncmc_payroll.admin.mst_Country" %>
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>Country Master (Add/Edit/Delete)</h3>
                                </div>
            
                                <div class="gadgetblock">
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            <td style="width:19%;">Country Name</td>
                                            <td style="width:1%;">:</td>
                                            <td style="width:80%;">
                                                <asp:TextBox ID="txtCountry" runat="server" MaxLength="50" TabIndex="1" />
                                                <asp:RequiredFieldValidator ID="ReqCountry" ControlToValidate="txtCountry"
                                                    SetFocusOnError="true" Display="Dynamic" runat="server" ValidationGroup="VldMe"
                                                    ErrorMessage="<br/> Country Name Required. " CssClass="errText" />
                                                <asp:RegularExpressionValidator ID="ReqExpCountr" runat="server"  ValidationGroup="VldMe"
                                                    Display="Dynamic" ValidationExpression="[a-z A-Z]*" ControlToValidate="txtCountry"
                                                    ErrorMessage="<br/>Required value for Country Name should be Alphabets only." CssClass="errText" />
                                            </td>
                                        </tr>
                                    ...
                                    <div class="gadgetblock">
                                        <asp:GridView ID="grdDtls" runat="server" AllowSorting="true" OnRowCommand="grdDtls_RowCommand" OnPageIndexChanging="grdDtls_PageIndexChanging" OnSorting="grdDtls_Sorting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MiscName" SortExpression="MiscName" HeaderText="Country" ItemStyle-Width="85%" />
