<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="mst_Bank.aspx.cs" Inherits="bncmc_payroll.admin.mst_Bank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        nextfield = "ctl00_ContentPlaceHolder1_txtBank";
        netscape = "";
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>Bank Master (Add/Edit/Delete)</h3>
                                </div>
                                ...
                                <div class="gadgetblock">
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td style="width:1%;">:</td>
                                            <td style="width:80%">
                                                <asp:TextBox ID="txtBank" runat="server" SkinID="skn400" MaxLength="50" TabIndex="1" />
                                                <asp:RequiredFieldValidator ID="ReqCountry" ControlToValidate="txtBank"
                                                    SetFocusOnError="true" Display="Dynamic" runat="server" ValidationGroup="VldMe"
                                                    ErrorMessage="Bank Name Required. " CssClass="errText" />
                                                <asp:RegularExpressionValidator ID="RglrVld_Interestrate" runat="server" 
                                                    Display="Dynamic" ValidationExpression="^[A-Z a-z].*$" ControlToValidate="txtBank" 
                                ...
                                <div class="gadget">
                                    <div>
                                        ...
                                        <asp:DropDownList ID="ddlSearch" runat="server" Width="110px">
                                            <asp:ListItem Value="BankName" Text="Bank"/>
                                        </asp:DropDownList>
                                    ...
                                    <div class="gadgetblock">
                                        <asp:GridView ID="grdDtls" runat="server" AllowSorting="true" OnRowCommand="grdDtls_RowCommand" OnPageIndexChanging="grdDtls_PageIndexChanging" OnSorting="grdDtls_Sorting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="BankName" SortExpression="BankName" HeaderText="Bank Name" ItemStyle-Width="90%" />
                            
                                                <asp:TemplateField ItemStyle-Width="5%" HeaderText="Action">
                                                    <ItemTemplate>                           
                                                        <asp:ImageButton ID="ImgEdit" ImageUrl="images/edit.png"  runat="server" CommandArgument='<%#Eval("BankID")%>' CommandName="RowUpd" ToolTip="View/Edit Record" />
                                                        <asp:ImageButton ID="imgDelete" ImageUrl="images/delete.png" runat="server" onclientclick="return confirm('Do you want to delete this Record?');" CommandArgument='<%#Eval("BankID")%>' CommandName="RowDel" ToolTip="Delete Record" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
