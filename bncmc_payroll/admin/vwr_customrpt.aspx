<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="vwr_customrpt.aspx.cs" Inherits="bncmc_payroll.admin.vwr_customrpt" %>
                        ...
                        <div class="gadget">
                            ...
                            <div class="gadgetblock">
                                <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <asp:PlaceHolder ID="phLoan" runat="server" Visible="false">
                                    <tr>
	                                    <td>Loan</td>
	                                    <td>:</td>
	                                    <td colspan="4"><asp:DropDownList id="ddl_LoanID" runat="server" TabIndex="6"  Width="190px"/></td>
                                    </tr>
                                    </asp:PlaceHolder>
                                    ...
                                    <tr>
                                        <td>Month</td>
                                        <td>:</td>
                                        <td><asp:DropDownList ID="ddlMonth" runat="server" TabIndex="7"  Width="190px"/></td> 
                                         <td>Order By</td>
                                        <td>:</td>
                                        <td><asp:DropDownList ID="ddl_OrderBy" runat="server" TabIndex="9"  Width="190px"/></td>
                                    </tr>
                                    
                                    <asp:PlaceHolder ID="phBnkDedDtlsSmry" runat="server" >
                                    <tr>
                                        <td>Show</td>
                                        <td>:</td>
                                        <td colspan="4">
                                            <asp:DropDownList ID="ddl_Show" runat="server" TabIndex="8"  Width="190px" Enabled="false">
                                                <asp:ListItem Text="Detail" Value="0" Selected="True"></asp:ListItem>
                                    ...
                                    <tr>
                                        <td colspan="6" align="center">
                                            <asp:Button ID="btnShow" runat="server" Text="Show Report" TabIndex="8" CssClass="button" OnClick="btnShow_Click" />
