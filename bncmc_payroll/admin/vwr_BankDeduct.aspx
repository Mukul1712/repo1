<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="vwr_BankDeduct.aspx.cs" Inherits="bncmc_payroll.admin.vwr_BankDeduct" %>
                            ...
                            <div class="gadgetblock">
                                <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:DropDownList ID="ddl_DeptID" runat="server" TabIndex="2" />
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:DropDownList ID="ddl_EmpID" runat="server" TabIndex="4" />
                                        ...
                                        <td>Employee ID</td>
                                        <td>:</td>
                                        <td><asp:TextBox ID="txtEmpID" runat="server" TabIndex="5" /></td>
                                    </tr>

                                    <tr>
	                                    <td>Loan</td>
	                                    <td>:</td>
	                                    <td colspan="4"><asp:DropDownList id="ddl_LoanID" runat="server" TabIndex="6" /></td>
                                    </tr>

                                    <tr>
                                        <td>Month</td>
                                        <td>:</td>
                                        <td colspan="4"><asp:CheckBoxList ID="Chk_MonthID" runat="server" TabIndex="7" RepeatColumns="7" RepeatDirection="Horizontal" /></td>
                                    </tr>

                                    <tr>
                                        <td>Order By</td>
                                        <td>:</td>
                                        <td colspan="4"><asp:DropDownList ID="ddl_OrderBy" runat="server" TabIndex="8" /></td>
                                    </tr>
