<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="mst_State.aspx.cs" 
    Inherits="bncmc_payroll.admin.mst_State" %>
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>State Master (Add/Edit/Delete)</h3>
                                </div>
                                    ...
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td style="width:78%">
                                                ...
                                                <uc_ajax:CascadingDropDown ID="ccd_Country" runat="server" Category="Country" TargetControlID="ddl_Country"  SelectedValue="1"
                                                    LoadingText="Loading Country..." PromptText="Select Country" ServiceMethod="BindCountry" ServicePath="~/ws/FillCombo.asmx"/>
                                                <asp:CustomValidator id="CustVld_Country" runat="server" ErrorMessage="<br/>Select ward"
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="txtstate" runat="server" MaxLength="50" TabIndex="2"/>
                                                <asp:RequiredFieldValidator ID="ReqCountry" ControlToValidate="txtstate"
                                                    SetFocusOnError="true" Display="Dynamic" runat="server" ValidationGroup="VldMe"
                                                    ErrorMessage="<br/> State Name Required. " CssClass="errText" />
                                                <asp:RegularExpressionValidator ID="ReqExpCountr" runat="server"  ValidationGroup="VldMe"
                                                    Display="Dynamic" ValidationExpression="[a-z A-Z]*" ControlToValidate="txtstate"
                                                    ErrorMessage="<br/>State Name should be Alphabets only." CssClass="errText" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="4" align="center">
                                                ...
                                                <asp:Button ID="btnReset" runat="server" Text="Reset" TabIndex="4" CssClass="groovybutton_red" OnClick="btnReset_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <asp:Panel ID="pnlDEntry" runat="server">
                                <div class="gadget">
                                    <div>
                                        <asp:Button ID="btnShowDtls_50" runat="server" Text="Show Details (50)" TabIndex="5" CssClass="groovybutton" OnClick="btnShowDtls_50_Click" />
                                        <asp:Button ID="btnShowDtls_100" runat="server" Text="Show Details (100)" TabIndex="6" CssClass="groovybutton" OnClick="btnShowDtls_100_Click" />
                                        <asp:Button ID="btnShowDtls" runat="server" Text="Show Details" TabIndex="7" CssClass="groovybutton" OnClick="btnShowDtls_Click" />

                                        <asp:DropDownList ID="ddlSearch" runat="server" Width="110px">
                                            <asp:ListItem Value="CountryName" Text="Country"/>
                                            <asp:ListItem Value="MiscName" Text="State Name" />
                                        </asp:DropDownList>
                                        <asp:TextBox ID="txtSearch" runat="server" SkinID="skn200" TabIndex="8" />
                                        <asp:Button ID="btnSearch" CssClass="groovybutton" Text="Filter" runat="server" OnClick="btnFilter_Click" TabIndex="9" />
                                        <asp:Button ID="btnClear" CssClass="groovybutton" Text="Clear" runat="server" OnClick="btnClear_Click" TabIndex="10" />
                                    </div>
                                    ...
                                    <div class="gadgetblock">
                                        <asp:GridView ID="grdDtls" runat="server" AllowSorting="true" OnRowCommand="grdDtls_RowCommand" OnPageIndexChanging="grdDtls_PageIndexChanging" OnSorting="grdDtls_Sorting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CountryName" SortExpression="CountryName" HeaderText="Country Name" ItemStyle-Width="30%" />
                                                <asp:BoundField DataField="MiscName" SortExpression="MiscName" HeaderText="State Name" ItemStyle-Width="60%" />
