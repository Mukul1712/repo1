<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="mst_class.aspx.cs" Inherits="bncmc_payroll.admin.mst_class" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        nextfield = "ctl00_ContentPlaceHolder1_txtClass";
        netscape = "";
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>Class Master (Add/Edit/Delete)</h3>
                                </div>
                                ...
                                <div class="gadgetblock">
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td style="width:1%;">:</td>
                                            <td style="width:80%">
                                                <asp:TextBox ID="txtClass" runat="server" SkinID="skn400" MaxLength="50" TabIndex="1" />
                                                <asp:RequiredFieldValidator ID="ReqClass" ControlToValidate="txtClass"
                                                    SetFocusOnError="true" Display="Dynamic" runat="server" ValidationGroup="VldMe"
                                                    ErrorMessage="Class Name Required. " CssClass="errText" />
                                                <asp:RegularExpressionValidator ID="RglrVld_Interestrate" runat="server" 
                                                    Display="Dynamic" ValidationExpression="^[A-Z a-z].*$" ControlToValidate="txtClass" 
                                                    ValidationGroup="VldMe" ErrorMessage="<br />Please Enter alphabets only." CssClass="errText" />
                                            </td>
                                        </tr>

                                        <tr>
                                            <td width="18%">Class Name (In Marathi)</td>
                                            <td style="width:1%;" class="text_red">&nbsp;</td>
                                            <td style="width:1%;">:</td>
                                            <td style="width:80%">
                                                <asp:TextBox ID="txtClassNameInMarathi" runat="server" SkinID="skn400" MaxLength="500" TabIndex="2" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:DropDownList id="ddlRtCnt" runat="server" TabIndex="3">
                                                    <asp:ListItem Text="58" Value="58" Selected="True" />
                                ...
                                <div class="gadget">
                                    <div>
                                        ...
                                        <asp:DropDownList ID="ddlSearch" runat="server" Width="110px">
                                            ...
                                            <asp:ListItem Value="RetirementYr" Text="Working Years"/>
                                        </asp:DropDownList>
                                    ...
                                    <div class="gadgetblock">
                                        <asp:GridView ID="grdDtls" runat="server" AllowSorting="true" OnRowCommand="grdDtls_RowCommand" OnPageIndexChanging="grdDtls_PageIndexChanging" OnSorting="grdDtls_Sorting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ClassName" SortExpression="ClassName" HeaderText="Class Name" ItemStyle-Width="35%" />
                                                <asp:BoundField DataField="ClassNameInMarathi" SortExpression="ClassNameInMarathi" HeaderText="Class Name (In Marathi)" ItemStyle-Width="30%" />
                                                <asp:BoundField DataField="RetirementYr" SortExpression="RetirementYr" HeaderText="Working Years" ItemStyle-Width="20%" />
                                                ...
                                                <asp:TemplateField ItemStyle-Width="5%" HeaderText="Action">
                                                    <ItemTemplate>                           
                                                        <asp:ImageButton ID="ImgEdit" ImageUrl="images/edit.png"  runat="server" CommandArgument='<%#Eval("ClassID")%>' CommandName="RowUpd" ToolTip="View/Edit Record" />
                                                        <asp:ImageButton ID="imgDelete" ImageUrl="images/delete.png" runat="server" onclientclick="return confirm('Do you want to delete this Record?');" CommandArgument='<%#Eval("ClassID")%>' CommandName="RowDel" ToolTip="Delete Record" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
