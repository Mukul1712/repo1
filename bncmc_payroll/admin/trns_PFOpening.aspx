<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="trns_PFOpening.aspx.cs" Inherits="bncmc_payroll.admin.trns_PFOpening" %>
...
<script type="text/JavaScript" language="JavaScript">
    ...
    { SelectALL($get('<%= grdOpening.ClientID %>'), "chk_Select", chk1); }
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>Opening (Add/Edit/Delete)<%--&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
                                ...
                                <div class="gadgetblock">
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        ...
                                        <tr>
                                            <td colspan="12">
                                                <asp:GridView ID="grdOpening" runat="server" DataKeyNames="StaffID,DepartmentID,DesignationID,WardID" SkinID="skn_np">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Width="19%" HeaderText="Employee Name">
                                                        ...
                                                        <asp:TemplateField ItemStyle-Width="7%" HeaderText="PF Opening">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtOpening" runat="server" SkinID="skn80" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                         <asp:TemplateField ItemStyle-Width="7%" HeaderText="Pension Contr.">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtOpening_PC" runat="server" SkinID="skn80" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                         <asp:TemplateField ItemStyle-Width="7%" HeaderText="LIC">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtOpening_LIC" runat="server" SkinID="skn80" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
