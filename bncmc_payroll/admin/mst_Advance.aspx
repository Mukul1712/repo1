...
CodeBehind="mst_Advance.aspx.cs" Inherits="bncmc_payroll.admin.mst_Advance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/JavaScript" language="JavaScript">
        function pageLoad() {
            ...
            $get('<%= txtAdvTypeName.ClientID %>').focus();
        }
    ...
    <script type="text/javascript">
        nextfield = "ctl00_ContentPlaceHolder1_txtAdvTypeName";
        netscape = "";
                        ...
                        <div class="leftblock1 vertsortable">
                            <div class="gadget">
                                <div class="titlebar vertsortable_head">
                                    <h3>Advance Master (Add/Edit/Delete)</h3>
                                </div>
            
                                <div class="gadgetblock">
                                    <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            <td style="width:18%">Advance Name</td>
                                            <td style="width:1%" class="text_red">*</td>
                                            <td style="width:1%;">:</td>
                                            <td style="width:3%">
                                                <asp:TextBox ID="txtAdvTypeName" runat="server" MaxLength="50" TabIndex="1" />
                                                <asp:RequiredFieldValidator ID="ReqAdvTypeName" ControlToValidate="txtAdvTypeName" SetFocusOnError="true" Display="Dynamic" 
                                                    runat="server"  ValidationGroup="VldMe" ErrorMessage="Please Enter a Advance Type" CssClass="errText" />
                                                <asp:RegularExpressionValidator ID="RglrVld_Interestrate" runat="server" 
		                                            Display="Dynamic" ValidationExpression="^[A-Z a-z].*$" ControlToValidate="txtAdvTypeName" ValidationGroup="VldMe"
		                                            ErrorMessage="Please Enter alphabets only." CssClass="errText" />
                                            </td>
                                            ...
                                            <td style="width:1%;">:</td>
                                            <td style="width:30%">
                                                <asp:TextBox ID="txtShortName" runat="server" MaxLength="20" TabIndex="2" />
                                                
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
		                                            Display="Dynamic" ValidationExpression="^[A-Z a-z].*$" ControlToValidate="txtShortName" ValidationGroup="VldMe"
		                                            ErrorMessage="Please Enter alphabets only." CssClass="errText" />
                                            </td>
                                        </tr>
                                ...
                                <div class="gadget">
                                    <div>
                                        ...
                                        <asp:DropDownList ID="ddlSearch" runat="server" Width="110px">
                                            <asp:ListItem Value="AdvanceName" Text="Advance"/>
                                        </asp:DropDownList>
                                    ...
                                    <div class="gadgetblock">
                                        <asp:GridView ID="grdDtls" runat="server" AllowSorting="true" OnRowCommand="grdDtls_RowCommand" OnPageIndexChanging="grdDtls_PageIndexChanging" OnSorting="grdDtls_Sorting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="AdvanceName" SortExpression="AdvanceName" HeaderText="Advance" ItemStyle-Width="60%" />
                                                <asp:BoundField DataField="AdvanceSC" SortExpression="AdvanceSC" HeaderText="Short Code" ItemStyle-Width="25%" />
                                                ...
                                                <asp:TemplateField ItemStyle-Width="5%" HeaderText="Action">
                                                    <ItemTemplate>                           
                                                        <asp:ImageButton ID="ImgEdit" ImageUrl="images/edit.png" runat="server" CommandArgument='<%#Eval("AdvanceID")%>' CommandName="RowUpd" ToolTip="View/Edit Record" />
                                                        <asp:ImageButton ID="imgDelete" ImageUrl="images/delete.png" runat="server" onclientclick="return confirm('Do you want to delete this Record?');" CommandArgument='<%#Eval("AdvanceID")%>' CommandName="RowDel" ToolTip="Delete Record" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
