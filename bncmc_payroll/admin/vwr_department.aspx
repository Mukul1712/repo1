<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/admin/admin_pyroll.Master" AutoEventWireup="true" CodeBehind="vwr_department.aspx.cs" Inherits="bncmc_payroll.admin.vwr_department" %>
                            ...
                            <div class="gadgetblock">
                                <table style="width:100%;" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        <td>Order By</td>
                                        <td>:</td>
                                        <td><asp:DropDownList ID="ddl_OrderBy" runat="server" TabIndex="3" width="190px"/></td>

                                        <asp:PlaceHolder ID="phEmployeeList" runat="server">
                                            <td width="18%">Employee List</td>
                                            <td width="1%" >:</td>
                                            <td width="30%">
                                                <asp:DropDownList ID="ddl_EmployeeList" runat="server" TabIndex="2" width="190px">
                                                    <asp:ListItem Text="--All--" Value="0" />
                                                    <asp:ListItem Text="With AadhaarNo" Value="1" />
                                                    <asp:ListItem Text="Without AadhaarNo" Value="2" />
                                                </asp:DropDownList>
                                            </td>
                                        </asp:PlaceHolder>
                                    </tr>
