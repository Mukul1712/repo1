<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_pyroll.Master" EnableEventValidation="false" AutoEventWireup="true" 
CodeBehind="trns_AuditTrans.aspx.cs" Inherits="bncmc_payroll.admin.trns_AuditTrans" %>
                                        ...
                                        <div style="overflow:auto;height:500px;">
                                            <asp:GridView ID="grdDetails" runat="server" SkinID="skn_np">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ItemStyle-Width="5%" HeaderText="Audit">
                                                        <HeaderTemplate>
                                                            <asp:CheckBox ID="chkSelectAll_Audit" runat="server" Text="Audit" onclick="SelectAll_Audit(this);" />
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkSelect_Audit" Checked='<%#(String.IsNullOrEmpty(Eval("AuditID").ToString()) ?false:true)%>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
