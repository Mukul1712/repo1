<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="bncmc_payroll.admin.adminlogin" %>
			    ...
			    <div id="login-content">
                    ...
                    <p>
                     ...
                     <p>
                        ...
                        <asp:RadioButtonList ID="rdbUserType" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Text="Department Operator" Value="1" />
                ...
                <div style="overflow: auto; width: 450px; height: 100px; background-color: #3A2F0B;color:White;border: 2px solid #000000">
					    <table width="70%" border="0" cellpadding="2" cellspacing="0" style="padding: 30px 10px 10px 10px;" class="form">
                            <tr>
                                ...
                                <td width="60%" ><asp:DropDownList ID="ddl_Year"  runat="server" OnSelectedIndexChanged="ddl_Year_SelectedIndexChanged" AutoPostBack="true"/></td>
                            </tr>

                            <tr>
                                <td width="10%">&nbsp;</td>
                                <td width="30%" style="font-size:15px;">Login Month :</td>
                                <td width="60%" ><asp:DropDownList ID="ddl_Month"  runat="server" /></td>
                            </tr>
                        </table>
                </div>
