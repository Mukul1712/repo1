...
{
    public partial class prn_SlrySlip_Windows : System.Web.UI.Page
    {
            ...
            if ((sRptType != null) && (sRptType == "prn_SnglSlip"))
            {
                ...
                using (IDataReader iDr = DataConn.GetRS("SELECT * FROM [fn_StaffPymtMain]() Where StaffPaymentID = " + Requestref.QueryStringNativeInt("SlryID")))
                {
                    if (iDr.Read())
                    {
                        ...
                        using (IDataReader iDrAllowance = DataConn.GetRS("SELECT * FROM [fn_StaffPymtAllowance_StaffWise](" + Requestref.QueryStringNativeInt("SlryID") + "," + iDr["StaffID"].ToString() + ")"))
                        {
                        ...
                        using (IDataReader iDrDeducation = DataConn.GetRS("SELECT * FROM [fn_StaffPymtDeduction_StaffWise](" + Requestref.QueryStringNativeInt("SlryID") + "," + iDr["StaffID"].ToString() + ")"))
                        {
